export const getTermsValue = (name) => {
  switch (name) {
    ...
    <div class="section">
        <h2>여러분을 환영합니다.</h2>
        <p>SparkFit 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 SparkFit 서비스의 이용과 관련하여 SparkFit 서비스를 제공하는 SparkFit 주식회사(이하 ‘SparkFit’)와 이를 이용하는 회원(이하 ‘회원’) 간의 권리 및 의무, 이용 조건 등을 규정합니다.</p>
